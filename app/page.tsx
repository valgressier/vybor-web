    ...
    <main className="flex flex-col min-h-screen">
      ...
      <footer className="border-t border-[#252538] px-6 py-8 text-center text-sm text-[#555575]">
        <div className="flex flex-wrap justify-center gap-5 mb-3">
          ...
          <a href="mailto:admin@vybor.app" className="hover:text-white transition-colors">
            Contact
          </a>
        </div>
...
const features = [
  {
    emoji: "🗳️",
    title: "Sondages express",
    description:
      "Créez des questions Oui/Non, à choix multiples ou sur une échelle en quelques secondes.",
    color: "#FF4D6A",
  },
  {
    emoji: "🔒",
    title: "Confidentialité flexible",
    description:
      "Partagez publiquement, avec vos abonnés ou dans des groupes privés.",
    color: "#7B61FF",
  },
  {
    emoji: "💬",
    title: "Discussions riches",
    description:
      "Commentez, débattez et échangez en messages privés avec d'autres utilisateurs.",
    color: "#3ECFA8",
  },
  {
    emoji: "🔔",
    ...
    description:
      "Suivez vos votes, nouveaux abonnés et réponses instantanément.",
    color: "#FFB84D",
  },
  {
    emoji: "👥",
    ...
    description:
      "Rejoignez ou créez des groupes pour partager des opinions avec une communauté ciblée.",
    color: "#3E9EFF",
  },
  {
    emoji: "📊",
    ...
    description:
      "Visualisez les tendances et statistiques de vos sondages en temps réel.",
    color: "#8B5CF6",
  },
];
